...
interface ProcessedProductReport {
  code: string
...
type CatalogSyncProgressHandler = (event: CatalogSyncProgress) => void | Promise<void>
...
async function runCatalogSync(body: CatalogSyncRequest, onProgress?: CatalogSyncProgressHandler) {
